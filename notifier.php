...
$accounts = array(
    ...
    array( 'BCA', 'username', 'pi123', 'suwahadi@gmail.com', ( 60 * 5 ) ), // tiap 5 menit
...
function notify( $account, $balance, $new_balance, $transactions )
{
    ...
    $headers    = 'From: "Suwahadi Net"<suwahadi@gmail.com>' . "\n";


    $body       = 'Saldo Sekarang: Rp ' . number_format( ( $new_balance - 10000 ), 2 ); // 10 ribu saldo wajib di BCA
    $body      .= "\n\n" . 'Transaksi:' . "\n";
